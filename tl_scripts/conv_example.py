...
if __name__ == "__main__":
    ...
    if (not args.tune):
        program = convolution(N, C, H, W, F, K, S, D, P, tune=args.tune)(block_M=256, block_N=128, block_K=64, num_stages=4, threads=256)
        ...
        best_latency, best_config, ref_latency = convolution(N, C, H, W, F, K, S, D, P, tune=args.tune)
