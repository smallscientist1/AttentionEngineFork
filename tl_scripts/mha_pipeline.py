...
def flashattn(batch, heads, seq_len, dim, is_casual, tune=False):
    ...
    if tune:
        ...
        @jit(out_idx=[3], supply_type=tl.TensorSupplyType.Integer, ref_prog=None, profiler="auto")
...
if __name__ == "__main__":
    ...
    if (not args.tune):
        program = flashattn(batch, heads, seq_len, dim, is_casual, tune=args.tune)(block_M=128, block_N=128, num_stages=2, threads=256)
        ...
        best_latency, best_config, _ = flashattn(batch, heads, seq_len, dim, is_casual, tune=args.tune)
