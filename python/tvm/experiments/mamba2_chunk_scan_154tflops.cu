...
//             dA_cs_k_shared = T.alloc_shared((block_M), dtype, scope="shared")
...
extern "C" __global__ void __launch_bounds__(256) main_kernel(__grid_constant__ const CUtensorMap C_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap cb_desc, __grid_constant__ const CUtensorMap dA_cumsum_desc, __grid_constant__ const CUtensorMap dt_desc, __grid_constant__ const CUtensorMap prev_states_desc, __grid_constant__ const CUtensorMap x_desc) {
  ...
  __shared__ uint64_t _mbarrier[20];
  if (((int)threadIdx.x) == 0) {
    ...
    tl::mbarrier_init(_mbarrier[18], 128);
    tl::mbarrier_init(_mbarrier[19], 128);
  }
  __syncthreads();
  if (128 <= ((int)threadIdx.x)) {
    ...
    if (((int)threadIdx.x) == 128) {
      tl::tma_load(C_desc, _mbarrier[17], (&(((half_t*)buf_dyn_shmem)[24576])), 0, 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), (((int)blockIdx.z) & 7));
      tl::tma_load(C_desc, _mbarrier[17], (&(((half_t*)buf_dyn_shmem)[28672])), 64, 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), (((int)blockIdx.z) & 7));
    }
    if (((int)threadIdx.x) == 128) {
      tl::mbarrier_expect_tx(_mbarrier[17], 16384);
    }
    if (((int)threadIdx.x) == 128) {
      tl::tma_load(prev_states_desc, _mbarrier[17], (&(((half_t*)buf_dyn_shmem)[0])), 0, 0, ((int)blockIdx.x), (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      tl::tma_load(prev_states_desc, _mbarrier[17], (&(((half_t*)buf_dyn_shmem)[4096])), 64, 0, ((int)blockIdx.x), (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    ...
    for (int k = 0; k < (((int)blockIdx.y) + 1); ++k) {
      ...
      if (((int)threadIdx.x) == 128) {
        tl::tma_load(cb_desc, _mbarrier[(k & 1)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 4096) + 8192)])), (k * 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      ...
      if (((int)threadIdx.x) == 128) {
        tl::tma_load(x_desc, _mbarrier[((k & 1) + 6)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 4096) + 16384)])), 0, ((int)blockIdx.x), (((((int)blockIdx.z) >> 3) * 256) + (k * 64)), (((int)blockIdx.z) & 7));
      }
    ...
    tl::gemm_ss<64, 64, 128, 4, 1, 0, 1>((&(((half_t*)buf_dyn_shmem)[24576])), (&(((half_t*)buf_dyn_shmem)[0])), (&(acc_o[0])));
    #pragma unroll
    ...
    for (int k_1 = 0; k_1 < (((int)blockIdx.y) + 1); ++k_1) {
      ...
      for (int i_4 = 0; i_4 < 4; ++i_4) {
        tl::ptx_ldmatrix_x4((&(((half_t*)buf_dyn_shmem)[((((((((k_1 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_4 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(cb_local[(i_4 * 8)])));
      }
      tl::fence_proxy_async();
      ...
      tl::gemm_rs<64, 64, 64, 4, 1, 0, 0>((&(cb_local_prev[0])), (&(((half_t*)buf_dyn_shmem)[(((k_1 & 1) * 4096) + 16384)])), (&(acc_o[0])));
      tl::mbarrier_arrive(_mbarrier[((k_1 & 1) + 14)]);
    }
    tl::syncthreads_partial(_mbarrier[18]);
    #pragma unroll
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      tl::ptx_stmatrix_x4((&(((half_t*)buf_dyn_shmem)[(((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_11 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_11 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)])), __pack_half2(((half_t)acc_o[(i_11 * 8)]), ((half_t)acc_o[((i_11 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_11 * 8) + 2)]), ((half_t)acc_o[((i_11 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_11 * 8) + 4)]), ((half_t)acc_o[((i_11 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_11 * 8) + 6)]), ((half_t)acc_o[((i_11 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    tl::syncthreads_partial(_mbarrier[19]);
    if (((int)threadIdx.x) == 0) {
      tl::tma_store(Output_desc, (&(((half_t*)buf_dyn_shmem)[24576])), 0, ((int)blockIdx.x), (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), (((int)blockIdx.z) & 7));
    }
  }
}