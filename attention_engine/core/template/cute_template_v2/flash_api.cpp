...
void run_mha_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    if (params.d=={{dimqk}} && params.dv=={{dimv}}) {
        return run_mha_fwd_<90, {{cutlass_dtype}}, {{dimqk}}, {{dimv}}, false, false, false, false>(params, stream);
    }
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("get_scheduler_metadata", &mha_fwd_get_scheduler_metadata, "Get scheduler metadata");
}
