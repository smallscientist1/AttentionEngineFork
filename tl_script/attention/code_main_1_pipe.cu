  ...
  if (256 <= ((int)threadIdx.x)) {
    ...
    for (int k_1 = 0; k_1 < ((int)blockIdx.x); ++k_1) {
      ...
      for (int i_16 = 0; i_16 < 32; ++i_16) {
        float2 __5;
          float2 v__6 = *(float2*)(acc_o + (i_16 * 2));
          float2 v__7 = make_float2(m[(i_16 & 1)], m[(i_16 & 1)]);
          __5.x = (v__6.x*v__7.x);
          __5.y = (v__6.y*v__7.y);
      ...
      for (int i_18 = 0; i_18 < 32; ++i_18) {
        uint1 __6;
        float2 v__8 = *(float2*)(scores + (i_18 * 2));
        ((half2*)(&(__6.x)))->x = (half_t)(v__8.x);
        ((half2*)(&(__6.x)))->y = (half_t)(v__8.y);
        *(uint1*)(acc_s_cast + (i_18 * 2)) = __6;
      }
      tl::fence_proxy_async();
      ...
      for (int i_19 = 0; i_19 < 32; ++i_19) {
        float2 __7;
          ...
          float2 v__10 = make_float2(1.250000e-01f, 1.250000e-01f);
    ...
    for (int i_29 = 0; i_29 < 32; ++i_29) {
      float2 __11;
        float2 v__15 = *(float2*)(acc_o + (i_29 * 2));
        float2 v__16 = make_float2(m[(i_29 & 1)], m[(i_29 & 1)]);
        __11.x = (v__15.x*v__16.x);
        __11.y = (v__15.y*v__16.y);
      *(float2*)(acc_o + (i_29 * 2)) = __11;
    }
    #pragma unroll
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      m[i_30] = scores_max_0[i_30];
    }
    #pragma unroll
    for (int i_31 = 0; i_31 < 32; ++i_31) {
      uint1 __12;
      float2 v__17 = *(float2*)(scores + (i_31 * 2));
      ((half2*)(&(__12.x)))->x = (half_t)(v__17.x);
      ((half2*)(&(__12.x)))->y = (half_t)(v__17.y);
      *(uint1*)(acc_s_cast + (i_31 * 2)) = __12;
    }
    tl::fence_proxy_async();
    ...
    for (int i_35 = 0; i_35 < 32; ++i_35) {
      ...
      *(uint1*)(Output + (((((((((int)blockIdx.x) * 524288) + ((((int)threadIdx.x) >> 5) * 65536)) + ((i_35 & 1) * 32768)) + (((((int)threadIdx.x) & 31) >> 2) * 4096)) + (((int)blockIdx.y) * 128)) + ((i_35 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __14;
    }
