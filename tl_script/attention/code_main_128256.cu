...
extern "C" __global__ void __launch_bounds__(384) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, float* __restrict__ g_lse) {
  ...
  if (256 <= ((int)threadIdx.x)) {
    ...
    for (int k = 0; k < (((int)blockIdx.x) + 1); ++k) {
      ...
      if (((int)threadIdx.x) == 256) {
        tl::mbarrier_expect_tx(_mbarrier[((k & 1) + 2)], 65536);
      }
      if (((int)threadIdx.x) == 256) {
        tl::tma_load(V_desc, _mbarrier[((k & 1) + 2)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 32768) + 49152)])), 0, ((int)blockIdx.y), (k * 128), 0);
        tl::tma_load(V_desc, _mbarrier[((k & 1) + 2)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 32768) + 57344)])), 64, ((int)blockIdx.y), (k * 128), 0);
        tl::tma_load(V_desc, _mbarrier[((k & 1) + 2)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 32768) + 65536)])), 128, ((int)blockIdx.y), (k * 128), 0);
        tl::tma_load(V_desc, _mbarrier[((k & 1) + 2)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 32768) + 73728)])), 192, ((int)blockIdx.y), (k * 128), 0);
      }
    ...
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      float2 __1;
        ...
        float2 v__1 = make_float2(8.838835e-02f, 8.838835e-02f);
        __1.x = (v_.x*v__1.x);
        __1.y = (v_.y*v__1.y);
    ...
    for (int k_1 = 0; k_1 < ((int)blockIdx.x); ++k_1) {
      ...
      for (int i_16 = 0; i_16 < 32; ++i_16) {
        for (int vec_s_1 = 0; vec_s_1 < 2; ++vec_s_1) {
          float condval_1;
          if (((((((k_1 * 128) + ((i_16 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + vec_s_1) + 128) <= ((((((int)blockIdx.x) * 128) + ((((int)threadIdx.x) >> 5) * 16)) + ((i_16 & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      tl::gemm_rs<128, 256, 128, 8, 1, 0, 0>((&(acc_s_cast[0])), (&(((half_t*)buf_dyn_shmem)[(((k_1 & 1) * 32768) + 49152)])), (&(acc_o[0])));
      tl::mbarrier_arrive(_mbarrier[((k_1 & 1) + 6)]);
      #pragma unroll
      for (int i_19 = 0; i_19 < 32; ++i_19) {
        float2 __7;
          float2 v__9 = *(float2*)(scores + (i_19 * 2));
          float2 v__10 = make_float2(8.838835e-02f, 8.838835e-02f);
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
          scores_max_0[i_20] = max(scores_max_0[i_20], scores[((((rv_2 & 15) * 4) + (i_20 * 2)) + (rv_2 >> 4))]);
        }
      ...
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        ...
        for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
          scores_1_0_sum_0[i_27] = (scores_1_0_sum_0[i_27] + scores[((((rv_3 & 15) * 4) + (i_27 * 2)) + (rv_3 >> 4))]);
        }
    ...
    tl::gemm_rs<128, 256, 128, 8, 1, 0, 0>((&(acc_s_cast[0])), (&(((half_t*)buf_dyn_shmem)[(((((int)blockIdx.x) & 1) * 32768) + 49152)])), (&(acc_o[0])));
    ...
    for (int i_35 = 0; i_35 < 64; ++i_35) {
      ...
      *(uint1*)(Output + (((((((((int)blockIdx.x) * 655360) + ((((int)threadIdx.x) >> 5) * 81920)) + ((i_35 & 1) * 40960)) + (((((int)threadIdx.x) & 31) >> 2) * 5120)) + (((int)blockIdx.y) * 256)) + ((i_35 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __14;
    }
    if (((((int)threadIdx.x) & 3) >> 1) == 0) {
      g_lse[(((((((int)blockIdx.y) * 16384) + (((int)blockIdx.x) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))] = r[(((int)threadIdx.x) & 1)];
    }
  }
}
